function validarObjecto(objeto,nombre='obj'){
    if(!objeto
...
function deepMerge(objeto1,objeto2){
    validarObjecto(objeto1, objeto2);
    validarObjecto(objeto1, 'objeto2');
    const salida = {...objeto};
